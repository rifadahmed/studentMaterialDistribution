...
echo '<font size="3"><h2 style="text-align:center;font-family:century gothic;">EEE DEPARTMENT RESOURCES </h2></font>';

//////////////////////////////////////////txt files////
echo '<table style="color: pink" border="5px" cellpadding="5px" cellspacing="1px">';
echo " <tr><th>.............................................WORD FILE............................................</th></tr>";
for($a=2;$a<count($eee);$a++)
{
...
if(strpos($string,".txt")>0)
{
	...
	?>
	<tr> 
	<td><a download = "<?php echo $eee[$a]?>" href = "eee/<?php echo $eee[$a]?>"><?php echo $eee[$a]?></a>
<?php
?>
 </td>
	</tr>
