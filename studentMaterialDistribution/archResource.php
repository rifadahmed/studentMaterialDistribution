...
echo '<font size="3"><h2 style="text-align:center;font-family:century gothic;">ARCHITECTURE DEPARTMENT RESOURCES </h2></font>';
//////////////////////////////////////////txt files////
echo '<table style="color: pink" border="5px" cellpadding="5px" cellspacing="1px">';
echo " <tr><th>.............................................WORD FILE............................................</th></tr>";
for($a=2;$a<count($arch);$a++)
{
...
if(strpos($string,".txt")>0)
{
	...
	?>
	<tr> 
	<td><a download = "<?php echo $arch[$a]?>" href = "arch/<?php echo $arch[$a]?>"><?php echo $arch[$a]?></a>
<?php
?>
 </td>
	</tr>
