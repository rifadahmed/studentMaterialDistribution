...
echo '<font size="3"><h2 style="text-align:center;font-family:century gothic;">CSE DEPARTMENT RESOURCES </h2></font>';

//////////////////////////////////////////txt files////
echo '<table style="color: pink" border="5px" cellpadding="5px" cellspacing="1px">';
echo " <tr><th>...........................................WORD FILE.............................................</th></tr>";
for($a=2;$a<count($cse);$a++)
{
...
if(strpos($string,".txt")>0)
{
	...
	?>
	<tr> 
	<td><a download = "<?php echo $cse[$a]?>" href = "cse/<?php echo $cse[$a]?>"><?php echo $cse[$a]?></a>
<?php
?>
 </td>
	</tr>
